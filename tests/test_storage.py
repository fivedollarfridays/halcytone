"""Tests for halcytone.contracts.storage — raw SQL DDL + loader."""
...
from halcytone.contracts import storage
...
def test_read_ddl_uses_importlib_resources():
    pkg_text = resources.files("halcytone.contracts").joinpath("storage.sql").read_text(
        encoding="utf-8"
    )
