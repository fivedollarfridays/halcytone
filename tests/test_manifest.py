"""Tests for halcytone.contracts.bundles.manifest."""
...
_SCHEMA_PATH = _REPO_ROOT / "halcytone" / "contracts" / "bundles" / "manifest.schema.json"
...
def test_manifest_schema_is_packaged() -> None:
    ...
    data = (
        resources.files("halcytone.contracts.bundles")
