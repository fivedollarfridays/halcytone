"""Top-level export surface for `halcytone`.

Fleet consumers `from halcytone import SignalPacket, StateVector, ...`
...
class TestRequiredSchemaVersion:
    ...
    def test_equals_storage_schema_version(self) -> None:
        from halcytone.contracts.storage import SCHEMA_VERSION
...
class TestPublicSurface:
    ...
    def test_models_identity_matches_submodules(self) -> None:
        ...
        from halcytone.contracts.signals import (
            RESERVED_STREAMS,
            SignalPacket,
            StreamSpec,
        )
