#!/usr/bin/env python3
"""Regenerate ``halcytone/contracts/bundles/manifest.schema.json``.
...
from halcytone.contracts.bundles.manifest import SessionManifest  # noqa: E402

_OUTPUT_PATH = _REPO_ROOT / "halcytone" / "contracts" / "bundles" / "manifest.schema.json"
